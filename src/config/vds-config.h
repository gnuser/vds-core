/* src/config/vds-config.h.  Generated from vds-config.h.in by configure.  */
/* src/config/vds-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Vds Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Vds Core"
...
#define PACKAGE_NAME "V-Dimension"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "V-Dimension 0.9.9"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vds"
